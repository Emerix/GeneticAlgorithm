...
namespace Cars
{
    public class CarsSingle : GeneticSingleTestBase<CarParameters, CarScenario>, ICarsData
    {
        ...
        [Range(0.5f, 5)] [SerializeField] private float maxBoxSizeX = 5;
        [Range(0.5f, 2)] [SerializeField] private float maxBoxSizeY = 5;
        [Range(0.1f, 5f)] [SerializeField] private float maxWheelSize = 5;
        [Range(0.1f, 20f)] [SerializeField] private float maxSuspensionFrequency = 5;
